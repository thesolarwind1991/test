...
-- Дамп структуры базы данных finder
CREATE DATABASE IF NOT EXISTS `finder` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `finder`;

-- Дамп структуры для таблица finder.articles
CREATE TABLE IF NOT EXISTS `articles` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `Title` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  `Text` text COLLATE utf8mb4_general_ci NOT NULL,
  `Link` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
-- Дамп структуры для таблица finder.keyquery
CREATE TABLE IF NOT EXISTS `keyquery` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `code_article` bigint NOT NULL,
  `code_keyword` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `code_article` (`code_article`),
  KEY `code_keyword` (`code_keyword`)
...
-- Дамп структуры для таблица finder.keyword
CREATE TABLE IF NOT EXISTS `keyword` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `keyword` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- Дамп структуры базы данных peoples
CREATE DATABASE IF NOT EXISTS `peoples` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `peoples`;

-- Дамп структуры для таблица peoples.people
CREATE TABLE IF NOT EXISTS `people` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `fam` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
